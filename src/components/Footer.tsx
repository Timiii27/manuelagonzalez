      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            <div className="space-y-2 text-sm sm:text-base text-warm-gray/80">
              <p>hola@manuelagonzalez.com</p>
              <p>Madrid, España</p>
        ...
        >
          <p>© 2024 Manuela González. Todos los derechos reservados.</p>
          <p>Hecho con ❤️ para el arte</p>
        </motion.div>
      </div>
    </footer>
  );
